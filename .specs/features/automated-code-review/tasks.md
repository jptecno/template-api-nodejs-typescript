...
- [x] **T2 — Semgrep/reviewdog:** criar poucas regras testadas e workflow bloqueante seguro.
- [x] **T3 — Danger:** criar funções puras, testes e workflow bloqueante para políticas objetivas.
- [x] **T4 — PR-Agent:** configurar revisão advisory segura e focada na API.
- [x] **T5 — validação final:** executar todos os gates e registrar evidências e limitações.
